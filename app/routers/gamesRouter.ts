...
export const gamesRouter = () => {
    ...
    router.patch(
        ...
        body('chgkSettings.roundCount').optional().isInt({ min: 0, max: 30 }),
        body('chgkSettings.questionCount').optional().isInt({ min: 0, max: 30 }),
        body('matrixSettings.roundCount').optional().isInt({ min: 0, max: 30 }),
        body('matrixSettings.questionCount').optional().isInt({ min: 0, max: 30 }),
