                ...
                mediaMatch.matches ? (
                    ...
                    <div className={classes.userActionsWrapper}>
                        <Link className={classes.Profile} to={props.isAdmin ? '/admin/profile' : '/profile'}>
                            <img className={classes.Profile} src={profileImage} alt="Profile" id="profile" />
                        </Link>
                        <Link
                            className={classes.LogOut}
                            to={props.isLoggedIn ? '#' : props.isAdmin ? '/admin' : '/auth'}
                            onClick={handleLogout}
                        >
                            <img className={classes.LogOut} src={logOutImage} alt="LogOut" id="logout" />
                        </Link>
                    </div>
                )
            ) : null}
