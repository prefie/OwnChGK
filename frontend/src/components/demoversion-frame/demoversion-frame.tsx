    ...
    if (props.role === 'user') {
        return (
            <div className={classes.demoWrapper}>
                ...
                <p className={classes.demoCaption}>
                    Если хотите попробовать себя в роли админа, нажмите ссылку ниже. Мы создадим для вас демо-аккаунт
                    администратора на вашу почту пользователя.
                </p>
                <Link
                    to={'#'}
                    onClick={handleDemoLinkOnClick}
        ...
        return (
            <div className={classes.demoWrapper}>
                ...
                <p className={classes.demoCaption}>
                    Нажмите на ссылку ниже, и мы вернем вас обратно в интерфейс пользователя.
                </p>
                <Link
                    to={'#'}
                    onClick={handleDemoLinkOnClick}
