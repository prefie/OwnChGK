        ...
        <nav className={classes.MobileNavBar}>
            {!props.isGame ? (
                ...
                <div className={classes.gameLinkWrapper}>
                    <Link to={`/game/${props.gameId}`} className={`${classes['nav-item']}`} onClick={handleClick}>
                        В игру
                    </Link>
                </div>
            ) : (
                <div className={classes.gameLinkWrapper}>
                    <Link to={`/game-answers/${props.gameId}`} className={`${classes['nav-item']}`} onClick={handleClick}>
                        Ответы
                    </Link>
                </div>
            )}
