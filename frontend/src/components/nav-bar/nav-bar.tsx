            ...
            {props.isAdmin ? (
                <Fragment>
                    <Link
                        ...
                        id='games'
                        className={`${classes['nav-item']} ${classes['nav-item-admin']} ${
                            props.page === 'games' ? classes['is-active'] : null
                        }`}
                    ...
                    <Link
                        ...
                        id='teams'
                        className={`${classes['nav-item']} ${classes['nav-item-admin']} ${
                            props.page === 'teams' ? classes['is-active'] : null
                        }`}
                        onClick={handleIndicator}
                    >
                        Команды
                    ...
                    <Link
                        ...
                        id='admins'
                        className={`${classes['nav-item']} ${classes['nav-item-admin']}  ${
                            props.page === 'admins' ? classes['is-active'] : null
                        }`}
                        onClick={handleIndicator}
                    >
                        Админы
                ...
                <Fragment>
                    <Link
                        ...
                        id='teams'
                        className={`${classes['nav-item']} ${classes['nav-item-user']} ${
                            props.page === 'teams' ? classes['is-active'] : null
                        }`}
                        onClick={handleIndicator}
                    >
