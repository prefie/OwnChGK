        ...
        <Suspense fallback={<Loader />}>
            <Wrapper>
                <Switch>
                    ...
                    <ProtectedRoute
                        path="/admin/game-creation"
                        exact
                        currentUserRole={props.user.role}
                        neededRole={allAdminRoles}
                        redirectPath="/admin"
                    >
                        <GameCreator mode="creation" isAdmin={true} role={props.user.role} />
                    </ProtectedRoute>

                    <ProtectedRoute
                        path="/admin/game-creation/edit"
                        exact
                        currentUserRole={props.user.role}
                        neededRole={allAdminRoles}
                        redirectPath="/admin"
                    >
                        <GameCreator mode="edit" isAdmin={true} role={props.user.role} />
                    </ProtectedRoute>

                    <ProtectedRoute
                        path="/admin/team-creation"
                        exact
                        currentUserRole={props.user.role}
                        neededRole={allAdminRoles}
                        redirectPath="/admin"
                    ...
                    <ProtectedRoute
                        path="/admin/game/:gameId/:gamePart/answers/:tour/:question"
                        exact
                        currentUserRole={props.user.role}
                        neededRole={allAdminRoles}
                        redirectPath="/admin"
                    ...
                    <ProtectedRoute
                        path="/game-answers/:gameId/teamId/:teamId"
                        exact
                        currentUserRole={props.user.role}
                        neededRole={allAdminRoles}
                        redirectPath="/auth"
                    ...
                    <ProtectedRoute
                        ...
                        redirectPath="/auth"
                        currentUserRole={props.user.role}
                        extraCondition={mediaMatch.matches}
                    >
                        <MobileMenu />
                    </ProtectedRoute>
