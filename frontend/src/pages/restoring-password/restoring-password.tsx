    ...
    const renderStep = () => {
        switch (step) {
                ...
                return (
                    <form className={classes.stepWrapper} onSubmit={handleSendCode}>
                        ...
                        <div className={classes.form}>
                            ...
                            />
                            <button id={'restoreSend'} className={classes.sendButton} type="submit">
                                Отправить
                            </button>
                        </div>

                        <div
                            className={classes.linkToSignInWrapper}
                            style={{
                                justifyContent:
                                    isEmailInvalid && !mediaMatch.matches
                                        ? 'flex-end'
                                        : !isEmailInvalid && !mediaMatch.matches
                                          ? 'flex-end'
                                          : 'center',
                        ...
                        >
                            <Link className={classes.linkToSignIn} to={props.isAdmin ? '/admin' : '/auth'} id="remember">
                                Вспомнил пароль
                            </Link>
                        </div>
                    </form>
                    ...
                    <div className={classes.stepWrapper}>
                        ...
                        <div className={classes.secondStepForm}>
                            <CustomInput
                                ...
                                errorHelperText="Код неверный"
                                onFocus={() => setIsCodeInvalid(false)}
                            />
                            <button className={classes.sendButton} type="submit" onClick={handleCheckCode}>
                                Отправить
                            </button>
                        </div>
                        ...
                        <div className={classes.resendCodeWrapper}>
                            ...
                            <Link className={classes.resendCode} to="#" onClick={handleResendCode}>
                                Переотправить код
                            </Link>
                        </div>
                    </div>
            ...
            case 'third':
                return (
                    <div className={classes.stepWrapper}>
                        <p className={`${classes.instructionsParagraph} ${classes.thirdStep}`}>Придумайте новый пароль</p>
