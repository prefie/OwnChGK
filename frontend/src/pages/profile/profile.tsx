...
const Profile: React.FC<ProfileProps> = props => {
    ...
    const [flags, setFlags] = useState<{ isSuccess: boolean; isSnackbarOpen: boolean; isLoading: boolean }>({
        isSuccess: true,
    ...
    const handleSubmit = async (e: React.SyntheticEvent) => {
        ...
        if (userPassword === '') {
            ServerApi.changeName(userName, props.isAdmin).then(res => {
                if (res.status === 200) {
    ...
    return (
        <PageWrapper>
                ...
                <div className={classes.contentWrapper}>
                    <div className={classes.infoAndDemoWrapper}>
                        <div className={classes.infoWrapper}>
                            ...
                            <div
                                className={classes.infoCategoryWrapper}
                                style={{ marginTop: '3vh' }}
                            >
            ...
            >
                <Alert
                    onClose={handleClose}
                    severity={flags.isSuccess ? 'success' : 'error'}
                    sx={{ width: '100%' }}
                >
